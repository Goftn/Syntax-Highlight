...
/* ./.libs/lt-source-highlight.c - temporary wrapper executable for .libs/source-highlight.exe
...
const char * TARGET_PROGRAM_NAME = "source-highlight.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# source-highlight - temporary wrapper script for .libs/source-highlight.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7\n", f);
  fputs ("#\n", f);
  fputs ("# The source-highlight program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("    echo \"source-highlight.exe:source-highlight:$LINENO: libtool wrapper (GNU l", f);
  fputs ("ibtool) 2.4.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"source-highlight.exe:source-highlight:$LINENO: newargv[$lt_dump_args", f);
  fputs ("_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"source-highlight.exe:source-highlight:$LINENO: newargv[0]: $prog", f);
  ...
  fputs ("\n", f);
  fputs ("  program='source-highlight.exe'\n", f);
