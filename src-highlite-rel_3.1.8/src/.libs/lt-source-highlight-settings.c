...
/* ./.libs/lt-source-highlight-settings.c - temporary wrapper executable for .libs/source-highlight-settings.exe
   Generated by libtool (GNU libtool) 2.4.7

   The source-highlight-settings program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "source-highlight-settings.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# source-highlight-settings - temporary wrapper script for .libs/source-highlig", f);
  fputs ("ht-settings.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7\n", f);
  fputs ("#\n", f);
  fputs ("# The source-highlight-settings program cannot be directly executed until all t", f);
  fputs ("he libtool\n", f);
  ...
  fputs ("    echo \"source-highlight-settings.exe:source-highlight-settings:$LINENO: libt", f);
  fputs ("ool wrapper (GNU libtool) 2.4.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"source-highlight-settings.exe:source-highlight-settings:$LINENO: new", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"source-highlight-settings.exe:source-highlight-settings:$LINENO:", f);
  ...
  fputs ("\n", f);
  fputs ("  program='source-highlight-settings.exe'\n", f);
