...
/* ./.libs/lt-check-regexp.c - temporary wrapper executable for .libs/check-regexp.exe
   Generated by libtool (GNU libtool) 2.4.7

   The check-regexp program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "check-regexp.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# check-regexp - temporary wrapper script for .libs/check-regexp.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.7\n", f);
  fputs ("#\n", f);
  fputs ("# The check-regexp program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"check-regexp.exe:check-regexp:$LINENO: libtool wrapper (GNU libtool) ", f);
  fputs ("2.4.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"check-regexp.exe:check-regexp:$LINENO: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"check-regexp.exe:check-regexp:$LINENO: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='check-regexp.exe'\n", f);
