...
CIEPluginInterfaceForViewer InterfaceForViewer;

const char* WINDOW_CLASSNAME = "IE Viewer Class";
extern ATOM AtomObject;                                         // "property" okna s ukazatelem na objekt
...
extern int ConfigVersion;           // 0 - default, 1 - SS 1.6 beta 3, 2 - SS 1.6 beta 4, 3 - SS 2.5 beta 1, 4 - AS 3.1 beta 1
...
extern int WINAPI SalamanderPluginGetReqVer();
...
extern CPluginInterfaceAbstract* WINAPI SalamanderPluginEntry(CSalamanderPluginEntryAbstract* salamander);
...
void CIEPluginInterface::About(HWND parent)
{
    char buf[1000];
...
BOOL CIEPluginInterface::Release(HWND parent, BOOL force)
{
    CALL_STACK_MESSAGE2("CIEPluginInterface::Release(, %d)", force);
...
void CIEPluginInterface::LoadConfiguration(HWND parent, HKEY regKey, CSalamanderRegistryAbstract* registry)
{
    CALL_STACK_MESSAGE1("CIEPluginInterface::LoadConfiguration(, ,)");
...
void CIEPluginInterface::SaveConfiguration(HWND parent, HKEY regKey, CSalamanderRegistryAbstract* registry)
{
...
void CIEPluginInterface::Connect(HWND parent, CSalamanderConnectAbstract* salamander)
{
    CALL_STACK_MESSAGE1("CIEPluginInterface::Connect(,)");
...
CIEPluginInterface::GetInterfaceForViewer()
{
...
BOOL CIEPluginInterfaceForViewer::ViewFile(const char* name, int left, int top, int width,
...
{
    CALL_STACK_MESSAGE11("CIEPluginInterfaceForViewer::ViewFile(%s, %d, %d, %d, %d, "
                         "0x%X, %d, %d, , , , %d, %d)",
